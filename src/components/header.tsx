...
const mainMenu = [
  {
    ...
    dropdown: [
      ...
      },
      {
        ...
        url: "/about/contact",
        svg: (
          <Icons.InboxInOutline className="flex-shrink-0 h-6 w-6 text-kodi" />
        ),
        description:
    ...
    dropdown: [
      {
        ...
        description:
          "Add-ons for Kodi 19, the latest and greatest version of Kodi.",
      },
      {
        title: "Leia Add-ons",
        url: "/addons/leia",
    ...
    dropdown: [
      {
        ...
        svg: (
          <Icons.ChatAlt2Outline className="flex-shrink-0 h-6 w-6 text-kodi" />
        ),
    ...
    dropdown: [
      {
        ...
        url: "/contribute",
        svg: (
          <Icons.SupportOutline className="flex-shrink-0 h-6 w-6 text-kodi" />
        ),
        description:
